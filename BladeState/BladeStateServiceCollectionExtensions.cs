...
/// <summary>
	...
	/// </summary>
	public static IServiceCollection AddMemoryCacheBladeState<TState>(this IServiceCollection services, BladeStateProfile profile) where TState : class, new()
	{
	...
	/// </summary>
	public static IServiceCollection AddRedisBladeState<TState>(this IServiceCollection services, BladeStateProfile profile) where TState : class, new()
	{
		services.AddSingleton(profile);
		services.AddSingleton(new BladeStateCryptography(profile.EncryptionKey));
